...
namespace StudioBustAdjuster
{
    ...
    public partial class StudioBustAdjuster : BaseUnityPlugin
    {
        ...
        private void Start()
        {
            ...
            StudioBustAdjusterTimeline.PopulateTimeline();
        }
        ...
        internal static PushupController GetPushupController(OCIChar Char) => Char == null ? null : StudioObjectExtensions.GetChaControl(Char).GetComponent<Pushup.PushupController>();
    }
}
